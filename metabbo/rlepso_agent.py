...
from metabbo.agent_common import Memory, save_class
from metabbo.basic_agent import Basic_Agent
from metabbo.feature_utils import resolve_state_dim
...
class RLEPSO_Agent(Basic_Agent):
    def __init__(self, config, use_feature_extractor = False):
        ...
        config.feature_dim = resolve_state_dim(config, classic_dim=1, use_feature_extractor=use_feature_extractor)
