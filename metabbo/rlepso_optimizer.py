...
class RLEPSO_Optimizer(Learnable_Optimizer):
    ...
    def init_population(self, problem):
        ...
        self.__max_cost = safe_cost_scale(c_cost)
    ...
    def __get_state(self, problem):
        ...
        if self.fe is None:
            ...
            indiv_features = extract_features(self.fe, self.__particles['current_position'], self.__particles['c_cost'])[0]
    ...
    def update(self, action, problem):
        ...
        maybe_record_cost(self, self.fes, self.__particles['gbest_val'])
        ...
        if is_end:
            finalize_cost_history(self.cost, self.__particles['gbest_val'], self.__config.n_logpoint)
