...
from metabbo.optimizer_common import apply_ela_count, finalize_cost_history, maybe_record_cost, reset_cost_history
...
class RL_DAS_Optimizer(Learnable_Optimizer):
    ...
    def init_population(self, problem):
        ...
        reset_cost_history(self, self.population.gbest)
    ...
    def observe(self, problem):
        ...
        if self.fe is None:
            ...
            feature = extract_features(self.fe, self.population.group, self.population.cost)[0]
            feature = feature.cpu().numpy().mean(0)
        # =======================================================================
    ...
    def update(self, action, problem):
        ...
        maybe_record_cost(self, self.FEs, self.population.gbest)
        
        if self.done:
            finalize_cost_history(self.cost, self.population.gbest, self.n_logpoint)
